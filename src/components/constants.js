...
export const imageDescription = popupImageZoom.querySelector(
  ".popup__description"
);
...
export const linkAvatarInput = document.querySelector(".popup__status");
...
export const cardSubmit = document.getElementById("card_submit");

export const cardForm = document.getElementById("card_form")
